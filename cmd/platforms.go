...
func (i *Input) newPlatforms() map[string]string {
	platforms := map[string]string{
		...
		"ubuntu-20.04":   "ghcr.io/catthehacker/ubuntu:20.04-latest",
		"ubuntu-18.04":   "ghcr.io/catthehacker/ubuntu:18.04-latest",
		"ubuntu-16.04":   "ghcr.io/catthehacker/ubuntu:16.04-latest",
		"windows-latest": "",
		"windows-2019":   "",
		"macos-latest":   "",
		"macos-10.15":    "",
